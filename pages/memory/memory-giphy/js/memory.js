...
// push giphy images into the 'giphy_images' array
// for (var i = 0; i < giphy.data.length; i++) {
// 	createImg(giphy.data[i].images.fixed_width_small.url);
// }
...
$(".back").each(function(i) {
	...
	$(this).css('background-image', 'url(https://media2.giphy.com/media/sg32LhHk9RVLi/100w.gif)');
});

console.log("How claw-some is your memory??")
...
//--- GIPHY API ---//
var giphy = $.get("https://api.giphy.com/v1/stickers/search?q=cat&api_key=dc6zaTOxFJmzC");
giphy.done(function(data) { console.log("Success, got GIPHY data", data); });
